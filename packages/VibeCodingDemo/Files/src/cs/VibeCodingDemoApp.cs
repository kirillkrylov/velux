...
namespace VibeCodingDemoApp {

	/// <summary>
	/// This is a class that provides access to the application services.
	/// This is the MAIN entry point into the VibeCodingDemoApp package.
	/// </summary>
	public sealed class VibeCodingDemoApp {

		#region Fields: Private

		private static Lazy<VibeCodingDemoApp> _instance = new Lazy<VibeCodingDemoApp>(() => new VibeCodingDemoApp());
		...
		public static VibeCodingDemoApp Instance => _instance.Value;
		...
		private static ServiceProvider Init(){
			...
			serviceCollection.AddTransient<LocalizableStrings.ILocalizableStringResolver, LocalizableStrings.LocalizableStringResolver>();
		...
		/// </summary>
		/// <returns></returns>
		internal VibeCodingDemoApp Reset(){
			_serviceProvider.Value?.Dispose();
			_instance = null;
			_instance = new Lazy<VibeCodingDemoApp>(() => new VibeCodingDemoApp());
